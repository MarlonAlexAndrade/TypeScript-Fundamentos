...
let fulano:Junior= new Junior("Mario", 22,"Superior Incompleto",["Cuidar dos juninhos"])

console.log(fulano);

let jose:Junior= new Junior("Zé",25);
...
let joao:Pleno = new Pleno("João",26,[fulano],"Backend")
